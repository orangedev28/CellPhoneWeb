...
namespace WebBanDTDD.Areas.Admin.Controllers
{
    ...
    public class OrderDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderID,ProductID,ProductName,Price,Quantity")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderID,ProductID,ProductName,Price,Quantity")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
